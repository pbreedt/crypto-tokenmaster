...
describe("TokenMaster", () => {
    ...
    describe("Occasions", () => {
        it('Returns occasions attributes', async () => {
          ...
          expect(occasion.ticketsAvailable).to.be.equal(OCCASION_MAX_TICKETS)
    ...
    describe("Listing", () => {
        it('Only owner can list occasions', async () => {
          await expect(tokenMaster.connect(buyer).list(
            OCCASION_NAME,
            OCCASION_COST,
            OCCASION_MAX_TICKETS,
            OCCASION_DATE,
    ...
    describe("Minting", () => {
        ...
        it('Updates ticket count', async () => {
          ...
          expect(occasion.ticketsAvailable).to.be.equal(OCCASION_MAX_TICKETS - 1)
        })
        ...
        it('Updates seat status', async () => {
          const owner = await tokenMaster.seatAssignment(ID, SEAT)
